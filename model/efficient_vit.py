...
class EfficientViT(nn.Module): 
    def __init__(self, config, channels=1280, selected_efficient_net = 0):
        ...
        # self.Vgg = timm.create_model('vgg11', pretrained=True)
        # self.featuresup = nn.Sequential(
        #     nn.Conv2d(in_channels=512, out_channels=1280, kernel_size=(1,1), stride=(1,1)),
        #     nn.ReLU()
        # )
